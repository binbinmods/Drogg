...
using UnityEngine;
using static Drogg.CustomFunctions;
using static Drogg.Plugin;
using static Drogg.DescriptionFunctions;
using static Drogg.DroggFunctions;
using System.Text;
using TMPro;
...
namespace Drogg
{
    ...
    internal class Traits
    {
        ...
        public static void GetAuraCurseQuantityModificationPostfix(Character __instance, ref int __result, string id, Enums.CardClass CC, ref bool ___useCache)
        {
            ...
            __result = quantityModification + 1;
            // ___useCache = false;
        ...
        //     if ((__instance != null && __instance.CardData != null && (__instance.CardData.Id == "Yetiformula" || __instance.CardData.CardName == "Recompilation Formula")) || id == "Yetiformula")
        //     {
        ...
        //     if (__instance != null && __instance.CardData != null && (__instance.CardData.Id == "Yetiformula" || __instance.CardData.CardName == "Recompilation Formula"))
        //     {
